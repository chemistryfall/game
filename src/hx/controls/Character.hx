...
class Character extends Container
{
	...
	{
		this.sprite = Asset.getImage("bomb_blast_blue.png", true);
		this.sprite.anchor.x = this.sprite.anchor.y = 0.5;
		this.sprite.scale.x = this.sprite.scale.y = 0.7;
		var sprite2:Sprite = Asset.getImage("bomb_blast_red.png", true);
		sprite2.anchor.x = sprite2.anchor.y = 0.5;
		sprite2.scale.x = sprite2.scale.y = 0.7;
		var sprite3:Sprite = Asset.getImage("bomb_blast_green.png", true);
		sprite3.anchor.x = sprite3.anchor.y = 0.5;
		sprite3.scale.x = sprite3.scale.y = 0.7;
		var sprite4:Sprite = Asset.getImage("bomb_blast_orange.png", true);
